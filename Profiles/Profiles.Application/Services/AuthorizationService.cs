...
namespace Profiles.Application.Services
{
    public class AuthorizationService : IAuthorizationService
    {
        ...
        public AuthorizationService(HttpClient httpClient, IConfiguration configuration)
        {
            ...
            _authorizationClientUrl = configuration["ProfilesAuthM2M:ServerUrl"];
            _clientSecret = configuration["ProfilesAuthM2M:ClientSecret"];
            _clientId = configuration["ProfilesAuthM2M:ClientId"];
        }
